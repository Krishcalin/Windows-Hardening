<#
.SYNOPSIS
    CIS Microsoft Windows Server 2019 Benchmark v3.0.1 — Compliance Scanner
.DESCRIPTION
    Read-only compliance scanner that checks current Windows Server 2019
    system state against the CIS Benchmark v3.0.1. Reports PASS/FAIL/WARN
...
.EXAMPLE
    .\CIS_WinServer2019_Scanner.ps1
    .\CIS_WinServer2019_Scanner.ps1 -ScanProfile L1_DC -HtmlPath report.html
    .\CIS_WinServer2019_Scanner.ps1 -ScanProfile All -JsonPath scan.json -MinSeverity HIGH
.NOTES
    Version : 1.0.0
...
param(
    ...
    [string]$LogPath = "$env:SystemRoot\Logs\CIS_WinServer2019_Scan",
...
$Script:BENCHMARK     = "CIS Microsoft Windows Server 2019 Benchmark v3.0.1"
...
function Test-Prerequisites {
    ...
    if ($r.OSBuild -ne "17763") {
        Write-ScanLog "WARNING: OS build $($r.OSBuild) detected. This scanner targets Server 2019 build 17763." "WARN"
    }
...
function Test-AuditPolicies {
    ...
    $controls = @(
        ...
        # 17.x Enhanced NTLM Auditing (new for Server 2019)
...
function Test-AdminTemplatesComputer {
    ...
    $controls = @(
        ...
        # 18.9.62.1 Windows Sandbox (new for 2019)
...
function Show-ConsoleReport {
    ...
    Write-Host "  CIS Windows Server 2019 Benchmark v3.0.1 Compliance Report" -ForegroundColor Cyan
    Write-Host "=" * 80 -ForegroundColor Cyan
...
function Export-JsonReport {
    ...
    $report = [ordered]@{
        scanner            = "CIS_WinServer2019_Scanner"
...
<title>CIS Windows Server 2019 Compliance Report</title>
<style>
...
<body>
<div class="header">
  <h1>CIS Microsoft Windows Server 2019 Benchmark v3.0.1</h1>
  <div class="sub">Compliance Scan Report &mdash; Generated by CIS_WinServer2019_Scanner v$($Script:VERSION)</div>
  <div class="meta">
...
$($rows.ToString())
  ...
  <div class="footer">CIS_WinServer2019_Scanner v$($Script:VERSION) &mdash; $($Script:BENCHMARK)</div>
</div>
<script>
(function(){
...
# Handle -Version flag
if ($Version) {
    Write-Host "CIS_WinServer2019_Scanner v$($Script:VERSION) ($($Script:BENCHMARK))"
    exit 0
}
