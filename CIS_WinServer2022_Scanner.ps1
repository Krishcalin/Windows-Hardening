<#
.SYNOPSIS
    CIS Microsoft Windows Server 2022 Benchmark v3.0.0 — Compliance Scanner
.DESCRIPTION
    Read-only compliance scanner that checks current Windows Server 2022
...
.EXAMPLE
    ...
    .\CIS_WinServer2022_Scanner.ps1 -ScanProfile L1_DC -HtmlPath report.html
    .\CIS_WinServer2022_Scanner.ps1 -ScanProfile All -JsonPath scan.json -MinSeverity HIGH
.NOTES
    Version : 1.0.0
...
param(
    ...
    [string]$LogPath = "$env:SystemRoot\Logs\CIS_WinServer2022_Scan",
...
$Script:BENCHMARK     = "CIS Microsoft Windows Server 2022 Benchmark v3.0.0"
...
function Test-Prerequisites {
    ...
    if ($r.OSBuild -ne "20348") {
        Write-ScanLog "WARNING: OS build $($r.OSBuild) detected. This scanner targets Server 2022 build 20348." "WARN"
    }
...
function Test-AccountPolicies {
    ...
    $controls = @(
        ...
        [PSCustomObject]@{ CIS_ID="1.2.4"; Title="Ensure 'Allow Administrator account lockout' is set to 'Enabled'"; Profile="L1_MS,L1_DC"; Category="Account Policies"; Subcategory="Account Lockout Policy"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\SAM"; CheckValue="AllowAdministratorLockout"; Operator="EQ"; Expected=1; Recommendation="Enable Administrator account lockout to prevent brute-force attacks."; CWE="CWE-307" }
    )
...
function Test-UserRightsAssignment {
    ...
    $controls = @(
        ...
        [PSCustomObject]@{ CIS_ID="2.2.29"; Title="Log on as a batch job"; Profile="L1_DC"; Category="Local Policies"; Subcategory="User Rights Assignment"; Severity="MEDIUM"; CheckType="UserRight"; CheckKey="SeBatchLogonRight"; CheckValue=$null; Operator="SUBSET"; Expected="Administrators"; Recommendation="Limit 'Log on as a batch job' to Administrators on DCs."; CWE="CWE-269" },
...
function Test-SecurityOptions {
    ...
    $controls = @(
        ...
        [PSCustomObject]@{ CIS_ID="2.3.7.9"; Title="Interactive logon: Machine account lockout threshold is 10 or fewer, not 0"; Profile="L1_MS,L1_DC"; Category="Security Options"; Subcategory="Interactive Logon"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"; CheckValue="MaxDevicePasswordFailedAttempts"; Operator="RANGE"; Expected="1,10"; Recommendation="Set machine account lockout threshold to 1-10 failed attempts."; CWE="CWE-307" },
        # 2.3.8 Microsoft Network Client
        [PSCustomObject]@{ CIS_ID="2.3.8.1"; Title="MS network client: Digitally sign communications (always)"; Profile="L1_MS,L1_DC"; Category="Security Options"; Subcategory="MS Network Client"; Severity="CRITICAL"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\LanmanWorkstation\Parameters"; CheckValue="RequireSecuritySignature"; Operator="EQ"; Expected=1; Recommendation="Enable mandatory SMB client signing."; CWE="CWE-311" },
        ...
        [PSCustomObject]@{ CIS_ID="2.3.9.2"; Title="MS network server: Digitally sign communications (always)"; Profile="L1_MS,L1_DC"; Category="Security Options"; Subcategory="MS Network Server"; Severity="CRITICAL"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters"; CheckValue="RequireSecuritySignature"; Operator="EQ"; Expected=1; Recommendation="Enable mandatory SMB server signing."; CWE="CWE-311" },
        ...
        [PSCustomObject]@{ CIS_ID="2.3.11.4"; Title="Network security: Configure encryption types allowed for Kerberos (AES only)"; Profile="L1_MS,L1_DC"; Category="Security Options"; Subcategory="Network Security"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters"; CheckValue="SupportedEncryptionTypes"; Operator="EQ"; Expected=2147483640; Recommendation="Set Kerberos to AES128+AES256+Future types only (2147483640). Do not allow RC4."; CWE="CWE-326" },
...
function Test-SystemServices {
    ...
    $controls = @(
        ...
        [PSCustomObject]@{ CIS_ID="5.12"; Title="Print Spooler (Spooler) is Disabled (DC)"; Profile="L1_MS,L1_DC"; Category="System Services"; Subcategory="Services"; Severity="CRITICAL"; CheckType="Service"; CheckKey="Spooler"; CheckValue=$null; Operator="IN"; Expected="Disabled,NotInstalled"; Recommendation="Disable Print Spooler on Domain Controllers."; CWE="CWE-284" },
        ...
        [PSCustomObject]@{ CIS_ID="5.28.1"; Title="Windows Push Notifications User Service (WpnUserService) is Disabled"; Profile="L2_MS,L2_DC"; Category="System Services"; Subcategory="Services"; Severity="LOW"; CheckType="Service"; CheckKey="WpnUserService"; CheckValue=$null; Operator="IN"; Expected="Disabled,NotInstalled"; Recommendation="Disable Windows Push Notifications User Service."; CWE="CWE-284" },
        ...
        [PSCustomObject]@{ CIS_ID="5.29.1"; Title="Windows Sandbox Service is Disabled or Not Installed"; Profile="L2_MS,L2_DC"; Category="System Services"; Subcategory="Services"; Severity="MEDIUM"; CheckType="Service"; CheckKey="CmService"; CheckValue=$null; Operator="IN"; Expected="Disabled,NotInstalled"; Recommendation="Disable Windows Sandbox (Container Manager) if not required."; CWE="CWE-284" },
        ...
        # 5.37 Microsoft Defender Core Service (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="5.37"; Title="Microsoft Defender Core Service (MDCoreSvc) is Running"; Profile="L1_MS,L1_DC"; Category="System Services"; Subcategory="Services"; Severity="HIGH"; CheckType="Service"; CheckKey="MDCoreSvc"; CheckValue=$null; Operator="IN"; Expected="Running"; Recommendation="Ensure Microsoft Defender Core Service is running for endpoint protection."; CWE="CWE-693" }
    )
...
function Test-AuditPolicies {
    ...
    $controls = @(
        ...
        # 17.x Enhanced NTLM Auditing
        [PSCustomObject]@{ CIS_ID="17.3.3"; Title="Audit NTLM Authentication in this Domain is set to Enable all"; Profile="L2_DC"; Category="Audit Policy"; Subcategory="NTLM Audit"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\Netlogon\Parameters"; CheckValue="AuditNTLMInDomain"; Operator="EQ"; Expected=7; Recommendation="Enable auditing of all NTLM authentication in the domain (7)."; CWE="CWE-778" },
        [PSCustomObject]@{ CIS_ID="17.3.4"; Title="Audit Incoming NTLM Traffic is set to Enable auditing for all accounts"; Profile="L2_MS,L2_DC"; Category="Audit Policy"; Subcategory="NTLM Audit"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0"; CheckValue="AuditReceivingNTLMTraffic"; Operator="EQ"; Expected=2; Recommendation="Enable auditing of incoming NTLM traffic for all accounts (2)."; CWE="CWE-778" },
        [PSCustomObject]@{ CIS_ID="17.3.5"; Title="Restrict NTLM: Outgoing NTLM traffic to remote servers is Audit all"; Profile="L2_MS,L2_DC"; Category="Audit Policy"; Subcategory="NTLM Audit"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0"; CheckValue="RestrictSendingNTLMTraffic"; Operator="GE"; Expected=1; Recommendation="Audit or deny outgoing NTLM traffic to remote servers (1=Audit, 2=Deny)."; CWE="CWE-778" }
    )
...
function Test-AdminTemplatesComputer {
    ...
    $controls = @(
        ...
        # 18.4.5 EnableCertPadding (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.4.5"; Title="MSS: (EnableCertPadding) Enable certificate padding validation"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="MSS Legacy"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Cryptography\WinTrust\Config"; CheckValue="EnableCertPaddingCheck"; Operator="EQ"; Expected="1"; Recommendation="Enable certificate padding validation to prevent Authenticode signature spoofing."; CWE="CWE-347" },
        ...
        [PSCustomObject]@{ CIS_ID="18.4.10"; Title="MSS: (TcpMaxDataRetransmissions IPv6) is set to 3"; Profile="L2_MS,L2_DC"; Category="Admin Templates"; Subcategory="MSS Legacy"; Severity="LOW"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters"; CheckValue="TcpMaxDataRetransmissions"; Operator="LE"; Expected=3; Recommendation="Set TCP max data retransmissions (IPv6) to 3."; CWE="CWE-400" },
        [PSCustomObject]@{ CIS_ID="18.4.11"; Title="MSS: (TcpMaxDataRetransmissions) is set to 3"; Profile="L2_MS,L2_DC"; Category="Admin Templates"; Subcategory="MSS Legacy"; Severity="LOW"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters"; CheckValue="TcpMaxDataRetransmissions"; Operator="LE"; Expected=3; Recommendation="Set TCP max data retransmissions to 3."; CWE="CWE-400" },
        [PSCustomObject]@{ CIS_ID="18.4.12"; Title="MSS: (WarningLevel) Percentage threshold for security event log is 90% or less"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="MSS Legacy"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\Eventlog\Security"; CheckValue="WarningLevel"; Operator="LE"; Expected=90; Recommendation="Set security event log warning threshold to 90% or less."; CWE="CWE-778" },
        [PSCustomObject]@{ CIS_ID="18.4.13"; Title="MSS: (NetBT NodeType) is set to P-node (2) to disable NetBIOS broadcast"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="MSS Legacy"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\NetBT\Parameters"; CheckValue="NodeType"; Operator="EQ"; Expected=2; Recommendation="Set NetBT NodeType to P-node (2) to disable broadcast name resolution."; CWE="CWE-441" },
        # 18.5 Network
        ...
        # 18.5.4.2 DNS over HTTPS (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.5.4.2"; Title="Configure DNS over HTTPS (DoH) name resolution"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Network"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient"; CheckValue="DoHPolicy"; Operator="GE"; Expected=2; Recommendation="Configure DNS over HTTPS to require DoH (2) or allow DoH (3)."; CWE="CWE-319" },
        ...
        # 18.5.9.x SMB hardening (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.5.9.1"; Title="SMBv1 client driver is disabled (DependOnService no MRxSmb10)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Network"; Severity="CRITICAL"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\mrxsmb10"; CheckValue="Start"; Operator="EQ"; Expected=4; Recommendation="Disable SMBv1 client driver (Start=4 disables the driver)."; CWE="CWE-327" },
        [PSCustomObject]@{ CIS_ID="18.5.9.2"; Title="SMB Authentication Rate Limiter delay is 2000ms or more"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Network"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters"; CheckValue="InvalidAuthenticationDelayTimeInMs"; Operator="GE"; Expected=2000; Recommendation="Set SMB authentication rate limiter to 2000ms or higher to slow brute-force attacks."; CWE="CWE-307" },
        [PSCustomObject]@{ CIS_ID="18.5.9.3"; Title="SMB server encryption with AES-256-GCM is required"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Network"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters"; CheckValue="AES256GCMEncryption"; Operator="EQ"; Expected=1; Recommendation="Enable SMB AES-256-GCM encryption for maximum transport security."; CWE="CWE-326" },
        ...
        # 18.5.x NTP (Windows Time Service)
        [PSCustomObject]@{ CIS_ID="18.5.23.1"; Title="Enable Windows NTP Client"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="NTP"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\W32Time\TimeProviders\NtpClient"; CheckValue="Enabled"; Operator="EQ"; Expected=1; Recommendation="Enable Windows NTP Client for accurate time synchronization."; CWE="CWE-1188" },
        [PSCustomObject]@{ CIS_ID="18.5.23.2"; Title="Enable Windows NTP Server is Disabled"; Profile="L1_MS"; Category="Admin Templates"; Subcategory="NTP"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\W32Time\TimeProviders\NtpServer"; CheckValue="Enabled"; Operator="EQ"; Expected=0; Recommendation="Disable Windows NTP Server on member servers."; CWE="CWE-284" },
        # 18.6 Printers
        ...
        # 18.6.3-7 Post-PrintNightmare printer hardening (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.6.3"; Title="Configure RPC connection settings: Protocol to use for outgoing RPC connections"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Printers"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\RPC"; CheckValue="RpcUseNamedPipeProtocol"; Operator="EQ"; Expected=0; Recommendation="Set outgoing RPC protocol to RPC over TCP (0) for Print Spooler."; CWE="CWE-319" },
        [PSCustomObject]@{ CIS_ID="18.6.4"; Title="Configure RPC listener settings: Protocols to allow for incoming RPC connections"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Printers"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\RPC"; CheckValue="RpcProtocols"; Operator="EQ"; Expected=5; Recommendation="Set RPC listener to RPC over TCP (5) for authentication."; CWE="CWE-287" },
        [PSCustomObject]@{ CIS_ID="18.6.5"; Title="Configure RPC over TCP port for Print Spooler"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Printers"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\RPC"; CheckValue="RpcTcpPort"; Operator="EQ"; Expected=0; Recommendation="Set RPC over TCP port to 0 (dynamic port allocation) for Print Spooler."; CWE="CWE-284" },
        [PSCustomObject]@{ CIS_ID="18.6.6"; Title="Limits print driver installation to Administrators"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Printers"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\PointAndPrint"; CheckValue="RestrictDriverInstallationToAdministrators"; Operator="EQ"; Expected=1; Recommendation="Restrict print driver installation to Administrators only."; CWE="CWE-269" },
        [PSCustomObject]@{ CIS_ID="18.6.7"; Title="Manage processing of Queue-specific files"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Printers"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers"; CheckValue="CopyFilesPolicy"; Operator="EQ"; Expected=1; Recommendation="Limit queue-specific file processing to color profiles only (1)."; CWE="CWE-434" },
        # 18.8 System
        ...
        [PSCustomObject]@{ CIS_ID="18.8.5.3"; Title="VBS: Credential Guard Configuration (Enabled with UEFI lock) - MS"; Profile="L1_MS"; Category="Admin Templates"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard"; CheckValue="LsaCfgFlags"; Operator="EQ"; Expected=1; Recommendation="Enable Credential Guard with UEFI lock (1) on Member Servers."; CWE="CWE-522" },
        [PSCustomObject]@{ CIS_ID="18.8.5.3"; Title="VBS: Credential Guard Configuration (Disabled) - DC"; Profile="L1_DC"; Category="Admin Templates"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard"; CheckValue="LsaCfgFlags"; Operator="EQ"; Expected=0; Recommendation="Disable Credential Guard on Domain Controllers (0)."; CWE="CWE-522" },
        [PSCustomObject]@{ CIS_ID="18.8.5.4"; Title="VBS: Hypervisor-Enforced Code Integrity (HVCI/KMCI)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard"; CheckValue="HypervisorEnforcedCodeIntegrity"; Operator="EQ"; Expected=1; Recommendation="Enable Hypervisor-Enforced Code Integrity (HVCI)."; CWE="CWE-693" },
        # 18.8.5.5 Secure Launch / System Guard (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.8.5.5"; Title="VBS: Secure Launch Configuration (System Guard)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard"; CheckValue="ConfigureSystemGuardLaunch"; Operator="EQ"; Expected=1; Recommendation="Enable Secure Launch (System Guard) for hardware-rooted boot integrity."; CWE="CWE-693" },
        # 18.8.5.7 Kernel DMA Protection (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.8.5.7"; Title="Kernel DMA Protection is Enabled"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\Kernel DMA Protection"; CheckValue="DeviceEnumerationPolicy"; Operator="EQ"; Expected=0; Recommendation="Enable Kernel DMA Protection to block direct memory access from external devices (0 = Block All)."; CWE="CWE-119" },
        ...
        [PSCustomObject]@{ CIS_ID="18.8.28.8"; Title="Sign-in and lock last interactive user automatically after a restart (DisableAutomaticRestartSignOn)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Logon"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"; CheckValue="DisableAutomaticRestartSignOn"; Operator="EQ"; Expected=1; Recommendation="Enable DisableAutomaticRestartSignOn to prevent automatic sign-in after restart."; CWE="CWE-287" },
        ...
        # 18.9.19 Group Policy Processing (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.19.4"; Title="Security policy processing: Do not apply during periodic background processing"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Group Policy"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\Group Policy\{827D319E-6EAC-11D2-A4EA-00C04F79F83A}"; CheckValue="NoBackgroundPolicy"; Operator="EQ"; Expected=0; Recommendation="Apply security policy during periodic background processing (0 = do not skip)."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.19.5"; Title="Security policy processing: Process even if the Group Policy objects have not changed"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Group Policy"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\Group Policy\{827D319E-6EAC-11D2-A4EA-00C04F79F83A}"; CheckValue="NoGPOListChanges"; Operator="EQ"; Expected=0; Recommendation="Process security policy even if GPOs have not changed (0 = always process)."; CWE="CWE-693" },
        ...
        # 18.9.47 Windows Defender Exploit Guard
        [PSCustomObject]@{ CIS_ID="18.9.47.4.1"; Title="Configure Attack Surface Reduction rules is Enabled"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR"; CheckValue="ExploitGuard_ASR_Rules"; Operator="EQ"; Expected=1; Recommendation="Enable Attack Surface Reduction rules."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.2"; Title="ASR: Block Office apps from creating executable content (3B576869-A4EC-4529-8536-B80A7769E899)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="3B576869-A4EC-4529-8536-B80A7769E899"; Operator="EQ"; Expected="1"; Recommendation="Set ASR rule to Block Office apps from creating executable content."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.3"; Title="ASR: Block Office apps from creating child processes (D4F940AB-401B-4EFC-AADC-AD5F3C50688A)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="D4F940AB-401B-4EFC-AADC-AD5F3C50688A"; Operator="EQ"; Expected="1"; Recommendation="Set ASR rule to Block Office apps from creating child processes."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.4"; Title="ASR: Block Win32 API calls from Office macro (92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="92E97FA1-2EDF-4476-BDD6-9DD0B4DDDC7B"; Operator="EQ"; Expected="1"; Recommendation="Block Win32 API calls from Office macros."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.5"; Title="ASR: Block Office apps from injecting code into other processes (75668C1F-73B5-4CF0-BB93-3ECF5CB7CC84)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="75668C1F-73B5-4CF0-BB93-3ECF5CB7CC84"; Operator="EQ"; Expected="1"; Recommendation="Block Office apps from injecting code into other processes."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.6"; Title="ASR: Block JavaScript or VBScript from launching downloaded executable content (D3E037E1-3EB8-44C8-A917-57927947596D)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="D3E037E1-3EB8-44C8-A917-57927947596D"; Operator="EQ"; Expected="1"; Recommendation="Block JS/VBS from launching downloaded executables."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.7"; Title="ASR: Block execution of potentially obfuscated scripts (5BEB7EFE-FD9A-4556-801D-275E5FFC04CC)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="5BEB7EFE-FD9A-4556-801D-275E5FFC04CC"; Operator="EQ"; Expected="1"; Recommendation="Block execution of potentially obfuscated scripts."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.8"; Title="ASR: Block executable content from email client and webmail (BE9BA2D9-53EA-4CDC-84E5-9B1EEEE46550)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="BE9BA2D9-53EA-4CDC-84E5-9B1EEEE46550"; Operator="EQ"; Expected="1"; Recommendation="Block executable content from email client and webmail."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.9"; Title="ASR: Block credential stealing from lsass.exe (9E6C4E1F-7D60-472F-BA1A-A39EF669E4B2)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="CRITICAL"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="9E6C4E1F-7D60-472F-BA1A-A39EF669E4B2"; Operator="EQ"; Expected="1"; Recommendation="Block credential stealing from lsass.exe."; CWE="CWE-522" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.10"; Title="ASR: Block untrusted and unsigned processes from USB (B2B3F03D-6A65-4F7B-A9C7-1C7EF74A9BA4)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="B2B3F03D-6A65-4F7B-A9C7-1C7EF74A9BA4"; Operator="EQ"; Expected="1"; Recommendation="Block untrusted/unsigned processes from USB."; CWE="CWE-829" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.11"; Title="ASR: Block process creations from PSExec and WMI (D1E49AAC-8F56-4280-B9BA-993A6D77406C)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="D1E49AAC-8F56-4280-B9BA-993A6D77406C"; Operator="EQ"; Expected="1"; Recommendation="Block process creations from PSExec and WMI commands."; CWE="CWE-693" },
        # 18.9.47.4.12-13 New ASR rules (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.47.4.12"; Title="ASR: Block persistence through WMI event subscription (E6DB77E5-3DF2-4CF1-B95A-636979351E5B)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="E6DB77E5-3DF2-4CF1-B95A-636979351E5B"; Operator="EQ"; Expected="1"; Recommendation="Block persistence through WMI event subscription."; CWE="CWE-546" },
        [PSCustomObject]@{ CIS_ID="18.9.47.4.13"; Title="ASR: Use advanced protection against ransomware (C1DB55AB-C21A-4637-BB3F-A12568109D35)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules"; CheckValue="C1DB55AB-C21A-4637-BB3F-A12568109D35"; Operator="EQ"; Expected="1"; Recommendation="Enable advanced protection against ransomware."; CWE="CWE-693" },
        # 18.9.47.5 Network Protection
        [PSCustomObject]@{ CIS_ID="18.9.47.5.1"; Title="Prevent users and apps from accessing dangerous websites"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Exploit Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\Network Protection"; CheckValue="EnableNetworkProtection"; Operator="EQ"; Expected=1; Recommendation="Enable Network Protection to block connections to dangerous websites."; CWE="CWE-829" },
        # 18.9.47.11 Windows Defender Antivirus
        [PSCustomObject]@{ CIS_ID="18.9.47.11.1"; Title="Configure detection for potentially unwanted applications (PUA) is Enabled (Block)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender"; CheckValue="PUAProtection"; Operator="EQ"; Expected=1; Recommendation="Enable PUA detection to Block (1)."; CWE="CWE-829" },
        [PSCustomObject]@{ CIS_ID="18.9.47.11.2"; Title="Scan all downloaded files and attachments is Enabled"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection"; CheckValue="DisableIOAVProtection"; Operator="EQ"; Expected=0; Recommendation="Enable scanning of all downloaded files and attachments."; CWE="CWE-829" },
        [PSCustomObject]@{ CIS_ID="18.9.47.11.3"; Title="Turn on real-time protection"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="CRITICAL"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection"; CheckValue="DisableRealtimeMonitoring"; Operator="EQ"; Expected=0; Recommendation="Do not disable real-time protection (0)."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.11.4"; Title="Turn on behavior monitoring"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection"; CheckValue="DisableBehaviorMonitoring"; Operator="EQ"; Expected=0; Recommendation="Do not disable behavior monitoring (0)."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.11.5"; Title="Turn on script scanning"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection"; CheckValue="DisableScriptScanning"; Operator="EQ"; Expected=0; Recommendation="Do not disable script scanning (0)."; CWE="CWE-693" },
        # 18.9.47.11.6-7 Tamper Protection and Controlled Folder Access (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.47.11.6"; Title="Configure Tamper Protection is Enabled"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="CRITICAL"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows Defender\Features"; CheckValue="TamperProtection"; Operator="EQ"; Expected=5; Recommendation="Enable Tamper Protection (5) to prevent malicious changes to Defender settings."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.11.7"; Title="Configure Controlled Folder Access is Enabled"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\Controlled Folder Access"; CheckValue="EnableControlledFolderAccess"; Operator="EQ"; Expected=1; Recommendation="Enable Controlled Folder Access to protect files from ransomware."; CWE="CWE-693" },
        # 18.9.47.12 Cloud-delivered Protection
        [PSCustomObject]@{ CIS_ID="18.9.47.12.1"; Title="Join Microsoft MAPS (cloud protection) is Enabled"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet"; CheckValue="SpynetReporting"; Operator="GE"; Expected=1; Recommendation="Join Microsoft MAPS for cloud-delivered protection (1=Basic, 2=Advanced)."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.12.2"; Title="Configure cloud-delivered protection level is High or higher"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\MpEngine"; CheckValue="MpCloudBlockLevel"; Operator="GE"; Expected=2; Recommendation="Set cloud-delivered protection level to High (2) or higher."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.12.3"; Title="Send file samples when further analysis is required (Send safe samples = 1)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet"; CheckValue="SubmitSamplesConsent"; Operator="EQ"; Expected=1; Recommendation="Set sample submission to 'Send safe samples' (1)."; CWE="CWE-693" },
        # 18.9.47.12.4 Extended cloud check (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.47.12.4"; Title="Configure extended cloud check timeout (20 seconds or more)"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\MpEngine"; CheckValue="MpBafsExtendedTimeout"; Operator="GE"; Expected=20; Recommendation="Set extended cloud check timeout to 20 seconds or more."; CWE="CWE-693" },
        # 18.9.47.15-16 File hash and packed exe scanning (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.47.15"; Title="Enable file hash computation for Windows Defender"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\MpEngine"; CheckValue="EnableFileHashComputation"; Operator="EQ"; Expected=1; Recommendation="Enable file hash computation for improved threat intelligence."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="18.9.47.16"; Title="Configure scanning of packed executables"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="Windows Defender"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Scan"; CheckValue="DisablePackedExeScanning"; Operator="EQ"; Expected=0; Recommendation="Do not disable scanning of packed executables (0)."; CWE="CWE-829" },
        # 18.9.62.1 Windows Sandbox
        [PSCustomObject]@{ CIS_ID="18.9.62.1"; Title="Windows Sandbox: Allow clipboard redirection is Disabled"; Profile="L2_MS,L2_DC"; Category="Admin Templates"; Subcategory="Windows Sandbox"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\Sandbox"; CheckValue="AllowClipboardRedirection"; Operator="EQ"; Expected=0; Recommendation="Disable clipboard redirection in Windows Sandbox."; CWE="CWE-200" },
        [PSCustomObject]@{ CIS_ID="18.9.62.2"; Title="Windows Sandbox: Allow networking is Disabled"; Profile="L2_MS,L2_DC"; Category="Admin Templates"; Subcategory="Windows Sandbox"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\Sandbox"; CheckValue="AllowNetworking"; Operator="EQ"; Expected=0; Recommendation="Disable networking in Windows Sandbox."; CWE="CWE-284" },
        ...
        # 18.9.100.3 LAPS (Local Administrator Password Solution) v2
        [PSCustomObject]@{ CIS_ID="18.9.100.3.1"; Title="LAPS: Enable local admin password management (BackupDirectory)"; Profile="L1_MS"; Category="Admin Templates"; Subcategory="LAPS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS"; CheckValue="BackupDirectory"; Operator="GE"; Expected=1; Recommendation="Enable LAPS password management (BackupDirectory 1=AAD, 2=AD)."; CWE="CWE-522" },
        [PSCustomObject]@{ CIS_ID="18.9.100.3.2"; Title="LAPS: Password complexity includes uppercase + lowercase + digits + specials"; Profile="L1_MS"; Category="Admin Templates"; Subcategory="LAPS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS"; CheckValue="PasswordComplexity"; Operator="GE"; Expected=4; Recommendation="Set LAPS password complexity to 4+ (all character classes)."; CWE="CWE-521" },
        [PSCustomObject]@{ CIS_ID="18.9.100.3.3"; Title="LAPS: Password length is 15 or more characters"; Profile="L1_MS"; Category="Admin Templates"; Subcategory="LAPS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS"; CheckValue="PasswordLength"; Operator="GE"; Expected=15; Recommendation="Set LAPS password length to 15 or more."; CWE="CWE-521" },
        [PSCustomObject]@{ CIS_ID="18.9.100.3.4"; Title="LAPS: Password age is 30 days or less"; Profile="L1_MS"; Category="Admin Templates"; Subcategory="LAPS"; Severity="MEDIUM"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS"; CheckValue="PasswordAgeDays"; Operator="LE"; Expected=30; Recommendation="Set LAPS password age to 30 days or less."; CWE="CWE-262" },
        # TLS 1.0 / TLS 1.1 deprecation (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.TLS.1"; Title="Disable TLS 1.0 Client"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="TLS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Client"; CheckValue="Enabled"; Operator="EQ"; Expected=0; Recommendation="Disable TLS 1.0 Client to enforce modern cryptographic protocols."; CWE="CWE-327" },
        [PSCustomObject]@{ CIS_ID="18.9.TLS.2"; Title="Disable TLS 1.0 Server"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="TLS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Server"; CheckValue="Enabled"; Operator="EQ"; Expected=0; Recommendation="Disable TLS 1.0 Server to enforce modern cryptographic protocols."; CWE="CWE-327" },
        [PSCustomObject]@{ CIS_ID="18.9.TLS.3"; Title="Disable TLS 1.1 Client"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="TLS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client"; CheckValue="Enabled"; Operator="EQ"; Expected=0; Recommendation="Disable TLS 1.1 Client to enforce modern cryptographic protocols."; CWE="CWE-327" },
        [PSCustomObject]@{ CIS_ID="18.9.TLS.4"; Title="Disable TLS 1.1 Server"; Profile="L1_MS,L1_DC"; Category="Admin Templates"; Subcategory="TLS"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Server"; CheckValue="Enabled"; Operator="EQ"; Expected=0; Recommendation="Disable TLS 1.1 Server to enforce modern cryptographic protocols."; CWE="CWE-327" },
...
function Test-BitLockerControls {
    ...
    $controls = @(
        ...
        # 18.9.11.2.4-5 BitLocker OS drive PIN/TPM (Server 2022 new)
        [PSCustomObject]@{ CIS_ID="18.9.11.2.4"; Title="BitLocker: Minimum PIN length for startup is 7 or more"; Profile="BL"; Category="BitLocker"; Subcategory="OS Drive"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\FVE"; CheckValue="MinimumPIN"; Operator="GE"; Expected=7; Recommendation="Set BitLocker minimum startup PIN length to 7 or more characters."; CWE="CWE-521" },
        [PSCustomObject]@{ CIS_ID="18.9.11.2.5"; Title="BitLocker: Configure TPM platform validation profile for native UEFI firmware"; Profile="BL"; Category="BitLocker"; Subcategory="OS Drive"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\FVE"; CheckValue="OSEnablePrebootInputProtectorsOnSlates"; Operator="EQ"; Expected=1; Recommendation="Configure TPM platform validation profile for UEFI firmware."; CWE="CWE-311" },
...
function Test-NextGenControls {
    ...
    $controls = @(
        ...
        # NG.7-9 Server 2022 new NG controls
        [PSCustomObject]@{ CIS_ID="NG.7"; Title="System Guard Secure Launch is Enabled"; Profile="NG"; Category="Next Generation"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard"; CheckValue="ConfigureSystemGuardLaunch"; Operator="EQ"; Expected=1; Recommendation="Enable System Guard Secure Launch for hardware-rooted boot attestation."; CWE="CWE-693" },
        [PSCustomObject]@{ CIS_ID="NG.8"; Title="Kernel DMA Protection is Active"; Profile="NG"; Category="Next Generation"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SOFTWARE\Policies\Microsoft\Windows\Kernel DMA Protection"; CheckValue="DeviceEnumerationPolicy"; Operator="EQ"; Expected=0; Recommendation="Verify Kernel DMA Protection is active (0 = Block All)."; CWE="CWE-119" },
        [PSCustomObject]@{ CIS_ID="NG.9"; Title="HVCI is Running in Enforced Mode"; Profile="NG"; Category="Next Generation"; Subcategory="Device Guard"; Severity="HIGH"; CheckType="Registry"; CheckKey="HKLM:\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity"; CheckValue="Enabled"; Operator="EQ"; Expected=1; Recommendation="Verify HVCI is running in enforced mode at the system level."; CWE="CWE-693" }
    )
...
function Show-ConsoleReport {
    ...
    Write-Host "  CIS Windows Server 2022 Benchmark v3.0.0 Compliance Report" -ForegroundColor Cyan
    Write-Host "=" * 80 -ForegroundColor Cyan
...
function Export-JsonReport {
    ...
    $report = [ordered]@{
        scanner            = "CIS_WinServer2022_Scanner"
...
<body>
<div class="header">
  <h1>CIS Microsoft Windows Server 2022 Benchmark v3.0.0</h1>
  <div class="sub">Compliance Scan Report &mdash; Generated by CIS_WinServer2022_Scanner v$($Script:VERSION)</div>
  <div class="meta">
...
$($rows.ToString())
  ...
  <div class="footer">CIS_WinServer2022_Scanner v$($Script:VERSION) &mdash; $($Script:BENCHMARK)</div>
</div>
<script>
(function(){
...
# Handle -Version flag
if ($Version) {
    Write-Host "CIS_WinServer2022_Scanner v$($Script:VERSION) ($($Script:BENCHMARK))"
    exit 0
}
